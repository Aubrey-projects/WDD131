...
function search() {
    ...
    let sortedRecipes = filteredRecipes.sort();
...
function tagTemplate(tags) {
    return tags.map((tags)=> `<button>${tag}</button>`).join(' ');
}
...
function recipesTemplate(recipe) {
    return `<div id="recipe-card">
                <div class="recipe-image">
                    <img class="recipe-photo" src="${recipe.image}" alt="A photo of apple crisp with a scoop of vanilla icecream on top."></div>
