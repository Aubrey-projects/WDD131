//----------------------------------------
const names = ["James", "Bob", "JOSH"]; // Uppercase letters come before lowercase letters in ASCII
// Sorts alphabetically, then by ASCII, and it does mutate the original list
names.sort();
console.log(names);
//----------------------------------------
...
ages.sort(); // Sorts by ASCII
console.log(ages);
//----------------------------------------

//----------------------------------------
const people = [{ name: "James"}, {name: "Bob"}, {name: "Josh"}];
people.sort(sortPeopleByName); // Sort doesn't know how to sort custom objects. So, nothing unless you put a functio in the sort
console.log(people);
...
//----------------------------------------
const people2 = [{name: "James", age: 33},
                {name: "Bob", age: 12},
                {name: "Josh", age:47}
];
people2.sort(sortPeopleByName); // still sorts by name because that is what we made our function to do.
// We could make a new function to also sort by age though.
console.log(people2);
//----------------------------------------

// Code copied in class
const hikes = [
  {
    name: "Bechler Falls",
    stub: "bechler_falls",
...
//   // filter results base on what they typed
//   const filteredHikes = hikes.filter(hike => {
//     // return true if there's a match, false if there isn't

//     // if(hike.name.toLocaleLowerCase().includes(userInput)) {
//     //   return true;
//     // } else {
//     //   return false;
//     // }
